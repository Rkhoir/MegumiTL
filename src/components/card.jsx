export default function Card(props) {
    ...
    return (
        <article class="bg-[rgba(17,17,20,0.9)] border border-white/[0.08] rounded-[18px] overflow-hidden transition-[transform,border-color,box-shadow] duration-200 ease-in-out min-h-full shadow-[0_8px_22px_rgba(0,0,0,0.18)] hover:-translate-y-1 hover:border-[rgba(255,94,197,0.55)] hover:shadow-[0_16px_32px_rgba(0,0,0,0.22)]">
